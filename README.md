...
6. 在网页 app 上实现组织者，演讲者，听众的注册，登录等用户管理功能，各种讲课的管理 （演讲者 - 课程 - 听众）的关系要体现出来。

7. 在微信小程序上，把 3. 和 4. 的功能实现。

8. 其他学生们自己想出来和设计的功能

9. 测试的数据在这里： https://github.com/orgs/pq-25-summer/discussions/3  你的解决方案应该至少能对这样的输入有令用户基本满意的结果。  
